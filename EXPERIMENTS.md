...
--result_path=[BO_GP_EI_SLSQP_ITER400]_D20_regret_plot.png \
--data_dir=./datasets/D=20_N=5 \
--niter=400

python3 bo_experiments.py \
--result_path=./results/BO_GP_EI_SLSQP_ITER50.json \
...
python3 bo_experiments.py \
--result_path=./results/BO_GP_EI_SLSQP_ITER30.json \
...
python3 regret_plot.py \
--result_path=/workspaces/BO_EXPERIMENTS/src/results/BO_GP_EI_SLSQP_ITER50.json \
--output_plot_dir=./results \
--is_log=0
